...
export default function UploadProducts({ onCloseProductModal, fetchData }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await axios.post("http://localhost:8000/api/upload-product", productData);
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen p-6">
        <div className="bg-gray-200 shadow-lg rounded-lg p-3 max-w-md w-full">
          ...
          <h1 className="text-xl font-bold pb-5">UPLOAD PRODUCTS</h1>
          ...
          <form onSubmit={handleSubmit} className="form mx-auto w-full">
            ...
            <div className="w-full my-3">
              ...
              <textarea onChange={handleChange} value={productData.description} name="description" id="description" className="rounded-md w-full py-2 pl-2 outline-none" placeholder="Product Description" required ></textarea>
            </div>
            ...
            <div className="text-center mb-5">
              <button className="px-4 py-2 bg-black rounded-md text-white hover:bg-slate-900">Upload Product</button>
            </div>
          </form>
        </div>
